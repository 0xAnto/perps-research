...
module anto::big_ordered_map {
    ...
    use anto::ordered_map::{Self, OrderedMap};
    ...
    #[test_only]
    public fun print_map<K: store, V: store>(self: &BigOrderedMap<K, V>) {
        // uncomment to debug:
    ...
    #[test]
    #[expected_failure(abort_code = 0x10002, location = anto::ordered_map)] /// EKEY_NOT_FOUND
